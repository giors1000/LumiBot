...
const MQTTClient = {
    ...
    config: {
        ...
        get broker() { return localStorage.getItem('LumiBot-BrokerIP') || 'YOUR_BROKER_ADDRESS_HERE'; },
    ...
    _onMessageArrived(message) {
        ...
        if (type === 'state') {
            try {
                // FAILSAFE: Do NOT force _online: true here. 
                // Retained state messages can be stale. Reliability comes from the 'availability' topic (LWT).
