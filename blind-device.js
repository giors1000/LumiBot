...
function handleStateUpdate(state) {
    ...
    if (state.targetPosition !== undefined && state.targetPosition !== BlindState.targetPosition) {
        ...
        if (!state.isMoving && Date.now() - (window._uiActionTimestamp || 0) > 3000) {
...
function animateVisualization() {
    ...
    function tick(now) {
        ...
        // Exponential smoothing, lowered to 0.002 for accurate, clean, smooth 
        // motion tracking of discrete real-time MQTT intervals
...
function setupSlider() {
    ...
    slider.addEventListener('input', (e) => {
        ...
        // Do NOT update the blind visual — that drives physical reality
        // and should only change when the device actually moves over MQTT.
