  ...
  function applyHomeBackup(data) {
    ...
    if (data.blinds && typeof data.blinds === 'object') {
      ...
      Object.keys(data.blinds).forEach(rawId => {
        ...
        if (b.config) sv.config = Object.assign({}, sv.config, b.config);
        ...
        const payload = (typeof BlindSchema !== 'undefined' && BlindSchema.buildConfigPayload)
          ? BlindSchema.buildConfigPayload(id, { rules: sv.rules, config: sv.config, linkedDeviceId: sv.linkedDeviceId }, rev)
          : { rules: sv.rules || {}, config: sv.config || {}, cfgRev: rev };
