...
function syncConfigUI(config) {
    ...
    // Timeout Values
    if (config.motionTimeout !== undefined) updateText('motionTimeoutValue', Utils.formatDuration(config.motionTimeout));
    if (config.manualTimeout !== undefined) updateText('manualTimeoutValue', Utils.formatDuration(config.manualTimeout));
